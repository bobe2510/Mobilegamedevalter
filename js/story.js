...
const KNIGHT_OPEN = [
  ...
  say('mage', '陛下放心。她想出去，就讓她出去。'),
  say('mage', '只是……得有人跟著。'),
  n('她把自己的人格複製了一份，放進一隻東方來的熊貓玩偶裡。'),
  say('mage', '去吧。好好保護那個笨蛋。'),
...
const MAGE_OPEN = [
  ...
  say('mage', '……斷了。'),
  say('mage', '熊貓還在動，但我連不上它。'),

  say('mage', '早知道就不管她說什麼，直接跟去了。', { cg: CG('mage', 'open-2') }),
  say('mage', '「被天才跟著就沒有挑戰性」——那種話，虧她說得出口。'),

  say('mage', '等我，笨蛋。', { cg: CG('mage', 'open-3') }),
];
...
const ELDER_END = [
  ...
  say('mage', '誰叫你沒事穿披風啊笨蛋', { name: '草叢裡的另一個聲音' }),
  n('長公主低頭，看了看自己的披風。'),
  n('……'),
